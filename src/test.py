...
print('search in bst:', t.search_bst(t.test_root3, 10).value == 10)
new_root1 = t.insert_bst_recursion1(t.test_root3, 1)
t.pre_order(new_root1)
print()
new_root2 = t.insert_bst_iteration(new_root1, 2)
t.pre_order(new_root2)
print()
new_root3 = t.remove_bst(new_root2, 1)
t.pre_order(new_root3)
print()
